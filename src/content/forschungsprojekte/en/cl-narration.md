...
We expect several useful effects from the (possibly partial) automation of the procedures: (i) the possibility of comparing larger quantities of life course narratives with each other; as a consequence of this, (ii) the chance to identify patterns in life course narration, and (iii) empirical validation of the underlying sociological theories. (iv) Effects for computational linguistics include improvements in computational linguistic methods and insights into combined procedures in which experts interact with AI tools.
